    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Gérez votre stock de médicaments</p>
            </div>
...
function genererCodeBarre() {
    // Générer un nouveau code-barres côté client pour prévisualisation
...
function calculerStockTotal() {
    ...
    // Afficher les informations FEFO
